...
This section covers complex implementation topics for large-scale and forward-looking websites.

## Detailed Guides

*   [Entity Linking with @id](entity-linking.md) - Building a connected data graph.
*   [AI & Schema](ai-and-schema.md) - Optimizing for LLMs and AI agents.
*   [Internationalization (i18n)](internationalization.md) - Handling global content.
