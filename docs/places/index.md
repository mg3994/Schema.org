...
A `Place` represents entities that have a physical extension.

## Detailed Guides

*   [Accommodations](accommodations.md) - Hotels, Rentals, Apartments.
...
*   **Landform**: Mountains, Rivers.
*   **Tourist Attraction**: Places that attract tourists.
