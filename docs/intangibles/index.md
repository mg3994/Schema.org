# Intangibles Schema Documentation

`Intangible` represents things that are not physical.

## Detailed Guides

*   [Structured Values](structured-values.md) - Addresses, Coordinates, Prices.
*   [Enumerations](enumerations.md) - Predefined lists of values.
*   [Offers & Orders](commerce.md) - Offers, Demands, Orders, Invoices.
*   [Ratings & Reviews](reviews.md) - Aggregate ratings, Critic reviews.
*   [Services & Reservations](services.md) - Services, Bookings, Trips.
*   [Roles & Jobs](roles.md) - Organization roles, Job postings.
